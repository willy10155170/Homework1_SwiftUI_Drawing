    ...
    var body: some View {
        ZStack{
            Path {path in //body
                ...
                //path.move(to: CGPoint(x: 275, y:505))
            ...
            Path { path in
                ...
                //path.addQuadCurve(to: CGPoint(x: 309, y: 652), control: CGPoint(x: 228, y: 540))
